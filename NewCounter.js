// INSTALAR npm install react-native-progress

import React, { useState, useEffect } from 'react';
import { Pedometer } from 'expo-sensors';
import { StyleSheet, Text, View } from 'react-native';
import * as Progress from 'react-native-progress'; // Importe a biblioteca de progresso
...
export default function StepCounter() {
  ...
  // Calcule o progresso em relação à meta (valor entre 0 e 1)
